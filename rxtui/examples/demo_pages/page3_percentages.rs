        ...
        node! {
            div(bg: black, dir: vertical, pad: 2, w_pct: 1.0, h: 50) [
                ...
                div(bg: bright_black, w: 60, h: 12, pad: 1, dir: vertical) [
                    div(bg: red, w_pct: 1.0, h_pct: 0.25) [
                        text("25% height", color: white)
                    ],
                    div(bg: green, w_pct: 1.0, h_pct: 0.5) [
                        text("50% height", color: black)
                    ],
                    div(bg: blue, w_pct: 1.0, h_pct: 0.25) [
                        text("25% height", color: white)
                    ]
                ],
                spacer(3),
                ...
                div(bg: bright_black, w: 60, h: 8, pad: 1, dir: horizontal) [
                    div(bg: cyan, w_pct: 0.2, h_pct: 1.0, pad: 1) [
                        text("20%", color: black)
                    ],
                    div(bg: magenta, w_pct: 0.3, h_pct: 1.0, pad: 1) [
                        text("30%", color: white)
                    ],
                    div(bg: yellow, w_pct: 0.5, h_pct: 1.0, pad: 1) [
                        text("50%", color: black)
                    ]
                ],
                spacer(3),
                ...
                div(bg: bright_black, w: 60, h: 12, pad: 1, dir: vertical) [
                    // Top row - 40% height
                    div(dir: horizontal, w_pct: 1.0, h_pct: 0.4) [
                        div(bg: bright_red, w_pct: 0.3, h_pct: 1.0, pad: 1) [
                            text("30%x40%", color: white)
                        ],
                        div(bg: bright_green, w_pct: 0.7, h_pct: 1.0, pad: 1) [
                            text("70%x40%", color: black)
                        ]
                    ],
                    // Bottom row - 60% height
                    div(dir: horizontal, w_pct: 1.0, h_pct: 0.6) [
                        div(bg: bright_blue, w_pct: 0.5, h_pct: 1.0, pad: 1) [
                            text("50%x60%", color: white)
                        ],
                        div(bg: bright_yellow, w_pct: 0.25, h_pct: 1.0, pad: 1) [
                            text("25%x60%", color: black)
                        ],
                        div(bg: bright_magenta, w_pct: 0.25, h_pct: 1.0, pad: 1) [
                ...
                div(bg: bright_black, w: 50, h: 10, pad: 1, dir: horizontal) [
                    div(bg: bright_cyan, w: 10, h_pct: 1.0, pad: 1) [
                        text("Fix 10", color: black)
                    ],
                    div(bg: bright_red, w_pct: 0.5, h_pct: 1.0, pad: 1) [
                        text("50% of parent (24)", color: white)
                    ],
                    div(bg: bright_green, w: 14, h_pct: 1.0, pad: 1) [
