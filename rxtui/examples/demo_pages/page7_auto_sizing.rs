        ...
        node! {
            div(bg: black, dir: vertical, pad: 2, w_pct: 1.0, h: 60) [
                ...
                div(bg: bright_black, w: 60, h: 6, pad: 1, dir: horizontal) [
                    div(bg: red, w_auto, h_pct: 1.0) [
                        text("Auto 1", color: white)
                    ],
                    div(bg: green, w_auto, h_pct: 1.0) [
                        text("Auto 2", color: black)
                    ],
                    div(bg: blue, w_auto, h_pct: 1.0) [
                ...
                spacer(1),
                div(bg: bright_black, w: 60, h: 6, pad: 1, dir: horizontal) [
                    div(bg: cyan, w: 10, h_pct: 1.0, pad: 1) [
                        text("Fixed 10", color: black)
                    ],
                    div(bg: magenta, w_auto, h_pct: 1.0, pad: 1) [
                        text("Auto", color: white)
                    ],
                    div(bg: yellow, w: 15, h_pct: 1.0, pad: 1) [
                ...
                div(bg: bright_black, w: 60, h: 6, pad: 1, dir: horizontal) [
                    ...
                    div(bg: bright_green, w_auto, h_pct: 1.0, pad: 1) [
                        text("Auto", color: black)
                    ],
                    div(bg: bright_blue, w_pct: 0.2, h_pct: 1.0, pad: 1) [
                        text("20%", color: white)
                    ]
                ],
                spacer(2),
                ...
                div(bg: bright_black, w: 80, h: 6, pad: 1, dir: horizontal) [
                    div(bg: bright_cyan, w: 12, h_pct: 1.0, pad: 1) [
                    ...
                    div(bg: bright_red, w_auto, h_pct: 1.0, pad: 1) [
                        text("Auto 2", color: white)
                    ],
                    div(bg: bright_green, w: 8, h_pct: 1.0, pad: 1) [
                ...
                div(bg: bright_black, w: 50, h: 20, pad: 1, dir: vertical) [
                    div(bg: red, w_pct: 1.0, h: 3) [
                        text("Fixed height 3", color: white)
                    ],
                    div(bg: green, w_pct: 1.0, h_auto) [
                        text("Auto height", color: black)
                    ],
                    div(bg: blue, w_pct: 1.0, h_pct: 0.3) [
                        text("30% height", color: white)
                    ],
                    div(bg: magenta, w_pct: 1.0, h_auto) [
